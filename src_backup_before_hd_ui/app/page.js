                            ...
                            <div className="header" style={{ marginBottom: '32px' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '20px' }}>
                                    <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                                        ...
                                        <div>
                                            <div style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', marginBottom: '4px' }}>Selamat datang kembali,</div>
                                            <h1 style={{ fontSize: '1.8rem', fontWeight: 800, display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px', background: 'linear-gradient(135deg, #FFFFFF 0%, #00D2FF 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                                                {displayName}
                                                <span style={{ fontSize: '1.5rem', WebkitTextFillColor: 'initial' }}>👋</span>
                                                <button
                                                    onClick={openEditInfo}
                                                    title="Edit info dashboard"
                                                    style={{ WebkitTextFillColor: 'initial', background: 'rgba(0,210,255,0.08)', border: '1px solid rgba(0,210,255,0.15)', borderRadius: '8px', padding: '4px 8px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s', marginLeft: '2px' }}
                                                    onMouseEnter={e => { e.currentTarget.style.background = 'rgba(0,210,255,0.18)'; e.currentTarget.style.borderColor = 'rgba(0,210,255,0.35)'; }}
                                                ...
                                                >
                                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#00D2FF" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                                                        <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
                                                        <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
                                                    </svg>
                                                </button>
                                            </h1>
                                            <p style={{ color: 'var(--text-tertiary)', fontSize: '0.9rem' }}>{displaySubtitle}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                                        ...
                                        {/* Date */}
                                        <div style={{ padding: '10px 16px', borderRadius: 'var(--r-lg)', border: '1px solid var(--border-medium)', background: 'rgba(0,0,0,0.3)', backdropFilter: 'blur(10px)', display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.85rem', fontWeight: 500, color: 'var(--text-primary)' }}>
                                            {currentDateStr || 'Memuat...'}
                                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--accent-blue)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                        </div>
